<div class="quote-right <?php if (get_sub_field('spacing')): ?> quote-right-spacing-none<?php endif; ?>">
    <div class="quote-right-wrapper" data-aos="fade-left">
        <div class="quote-right-content">
            ...
            <h3 class="quote-right-title article-quote-right-title">
                <?php the_sub_field('quote_title'); ?>
            </h3>
            <p class="quote-right-text article-quote-right-text">
