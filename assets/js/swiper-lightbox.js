(function () {
  ...
  function collectItems() {
    ...
    links.forEach(function (a) {
      ...
      var key =
        ...
        (a.closest(".swiper-slide") &&
          a.closest(".swiper-slide").getAttribute("data-idx")) ||
        a.getAttribute("href");
    ...
    itemsCache = uniqLinks.map(function (a) {
  ...
  document.addEventListener("click", function (e) {
    ...
    var index = Math.max(0, list.indexOf(link));
    openAt(index);
  });
  ...
  document.addEventListener("click", function (e) {
    ...
    e.preventDefault();
    var list = collectItems();
    if (list.length) openAt(0);
  });

  function openAt(startIndex) {
    var countLinks = itemsCache.length;
    ...
    totalEl.textContent = String(countLinks);
